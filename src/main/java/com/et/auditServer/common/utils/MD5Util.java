...
public class MD5Util {
     ...
     * 功能：得到一个盐加密的MD5值。
     */
    public static String getMD5StringBySalt(String str,String salt,int hashIterations) {
        String algorithmName = "MD5";//加密算法
        SimpleHash simpleHash = new SimpleHash(algorithmName,str,salt,hashIterations);
