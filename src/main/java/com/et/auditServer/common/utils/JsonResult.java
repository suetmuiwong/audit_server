...
public class JsonResult<T> {
    ...
    public static <T>  JsonResult<T> fail(T data) {
     ...
     public static <T>  JsonResult<T> fail(BusinessException e) {
         JsonResult<T> ret = new JsonResult<T>();
         ret.setCode(e.getErrorCode());
         ret.setMsg(e.getErrorMsg());
        return ret;
    }
    ...
    public static <T>  JsonResult<T> failMessage(JsonReturnCode jsonReturnCode) {
        JsonResult<T> ret = JsonResult.fail();
        ret.setCode(jsonReturnCode.getCode());
        ret.setMsg(jsonReturnCode.getDesc());
        return ret;
    }

    public static <T>  JsonResult<T> failMessageAndData(JsonReturnCode jsonReturnCode, T data) {
        JsonResult<T> ret = JsonResult.fail();
        ret.setCode(jsonReturnCode.getCode());
        ret.setMsg(jsonReturnCode.getDesc());
        ret.setData(data);
    ...
    public static <T>  JsonResult<T> failMessageAndData(String code,String desc, T data) {
        JsonResult<T> ret = JsonResult.fail();
        ret.setCode(code);
        ret.setMsg(desc);
        ret.setData(data);
