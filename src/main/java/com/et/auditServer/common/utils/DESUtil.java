...
public class DESUtil {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String afterJiami = encryption(var1,"15958070254004abcdef");
        System.out.println(afterJiami);//lWZ5YQcYFuoMB1ZmUoutXQ==
        System.out.println(decryption(afterJiami,"15958070254004abcdef"));

        System.out.println(MD5Util.getMD5StringBySalt("admin123","1",2));
